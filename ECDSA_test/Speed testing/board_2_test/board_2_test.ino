...
// Private ECDSA key of Board 2
const unsigned char hardcoded_private_key[] = {
    0x38, 0x47, 0x15, 0x73, 0x75, 0x89, 0xE6, 0x51, 0x93, 0x11,
    0xC4, 0xC3, 0x3A, 0x25, 0x02, 0x6D, 0x9D, 0x3D, 0x1E, 0xA2, 
    0xE4, 0xB5, 0x8C, 0x2E, 0x24, 0x07, 0xE4, 0xC8, 0x3E, 0xC7, 
    0x0E, 0x39};
