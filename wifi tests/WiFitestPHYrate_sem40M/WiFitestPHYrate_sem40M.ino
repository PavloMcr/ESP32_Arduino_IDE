...
//  bw_frame.hdr.frame_ctrl = 0xD0; //Action frame mgmt packet
...
//  bw_frame.hdr.category = 127;
//  bw_frame.hdr.organization_identifier[0]= 0x11;
//  bw_frame.hdr.organization_identifier[1]= 0x11;
//  bw_frame.hdr.organization_identifier[2]= 0x12;
...
void loop() {
  ...
  delay(1000);
  Serial.println("Transmitting packets");  
  vTaskDelay(10000);
